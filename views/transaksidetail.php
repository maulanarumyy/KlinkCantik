    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
      ...
      <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
          <h3><i class="fas fa-clipboard mr-2"></i> TRANSAKSI DETAIL </h3><hr>
          <a href="inputtrdetail.php" class="btn btn-success">Input Transaksi Detail</a> <br></br>
          ...
          <table class="table table-dark" >
            ...
            <tbody>
                <?php
                include "koneksi.php";
                $query    = mysqli_query($koneksi_db,"select * from apenjualandetail order by id_transaksi_detail");
                $no = 1;
                while ($data=mysqli_fetch_array($query)) {
                ?>           
                <tr class="odd gradeX">
                    <td><?php echo $no?></td>
                    <td><?php echo $data['id_transaksi_detail'];?></td>
